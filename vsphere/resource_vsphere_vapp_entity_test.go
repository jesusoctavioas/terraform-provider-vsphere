		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccResourceVSphereVAppEntityStartOrder("vapp_entity", 2),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccResourceVSphereVAppEntityStartOrder("vapp_entity1", 3),
...
resource "vsphere_vapp_entity" "vapp_entity1" {
  target_id      = "${vsphere_virtual_machine.vm1.id}"
  container_id   = "${vsphere_vapp_container.vapp_container.id}"
}

resource "vsphere_vapp_entity" "vapp_entity2" {
  target_id      = "${vsphere_virtual_machine.vm2.id}"
  container_id   = "${vsphere_vapp_container.vapp_container.id}"
}
